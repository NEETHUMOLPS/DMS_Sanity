...
public class ConfigBookmarkSign extends AbstractComponent{
	...
	public static boolean docTypeCreationAlert() throws InterruptedException
	{
		try
		{
			...
			Assert.assertTrue(alert1.getText().contains("Document Type added successfully"));
			alert1.accept();
			return true;
	...
	public static boolean editDocumentTyepALert() throws InterruptedException
	{
		try
		{
			WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofSeconds(10));
	...
	public static boolean bookmarkCreationALert() throws InterruptedException
	{
		try
		{
			WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofSeconds(10));
			wait1.until(ExpectedConditions.alertIsPresent());
			Alert alert1 = driver.switchTo().alert();
			Assert.assertTrue(alert1.getText().contains("Bookmark details added successfully"));
			alert1.accept();
			return true;
		} catch (NoAlertPresentException e) {
			return false;
